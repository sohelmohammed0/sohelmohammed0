...
# 👋 Hi, I'm Sohel Mohammed

### DevOps & Cloud Engineer · Hyderabad, India

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=58A6FF&center=true&vCenter=true&width=600&lines=AWS+%7C+Docker+%7C+Kubernetes+%7C+Terraform;CI%2FCD+%7C+GitOps+%7C+Infrastructure+as+Code;Automating+everything+that+can+be+automated)](https://git.io/typing-svg)
...
```
📌  Deploying multi-tier applications on AWS using ECS & EKS
📌  Building reusable Terraform modules for cloud provisioning
📌  Setting up GitOps pipelines with ArgoCD + GitHub Actions
📌  Monitoring infra health with Prometheus + Grafana dashboards
📌  Automating server config management with Ansible playbooks
```
...
> 💬 *Open to DevOps internships, cloud projects and collaborations. Let's build something resilient together!*
